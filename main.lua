...
AutoSitGroup:AddToggle("AutoSitBlob", {
    ...
    Callback = function(Value)
        ...
        if Value then
            task.spawn(AutoSitLoop)   -- start the loop (function defined below)
        end
    end
})

-- Paste this function anywhere above the toggle, or directly before it.
